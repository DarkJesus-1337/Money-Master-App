...
object FormatUtils {
     ...
     */
    fun formatDate(timestamp: Long, pattern: String = "dd.MM.yyyy", locale: Locale = Locale.getDefault()): String {
     ...
     */
    fun formatDateTime(timestamp: Long, pattern: String = "dd.MM.yyyy HH:mm", locale: Locale = Locale.getDefault()): String {
        val date = Date(timestamp)
        val dateFormat = SimpleDateFormat(pattern, locale)
        return dateFormat.format(date)
    }
